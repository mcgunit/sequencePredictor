...
if __name__ == "__main__":
    ...
    modelPath = os.path.join(os.path.abspath(os.path.join(path, os.pardir)), "test", "models", "unified")
    ...
    model.setEarlyStopPatience(model.epochs)
    model.setReduceLearningRatePatience(20)
