...
def train_model(model, train_data, val_data, modelName):
    ...
    checkpoint = ModelCheckpoint(os.path.join(os.path.abspath(os.path.join(path, os.pardir)), "data", "lstm_model", "model_{0}_checkpoint.keras".format(modelName)), save_best_only=True)
...
def main(args):
    ...
    if os.path.exists(os.path.join(os.path.abspath(os.path.join(path, os.pardir)), "data", "lstm_model", "model_{0}.keras".format(data))):
        model = load_model(os.path.join(os.path.abspath(os.path.join(path, os.pardir)), "data", "lstm_model", "model_{0}.keras".format(data)))
    elif os.path.exists(os.path.join(os.path.abspath(os.path.join(path, os.pardir)), "data", "lstm_model", "model_{0}_checkpoint.keras".format(data))):
        model = load_model(os.path.join(os.path.abspath(os.path.join(path, os.pardir)), "data", "lstm_model", "model_{0}_checkpoint.keras".format(data)))
    else:
    ...
    model.save(os.path.join(os.path.abspath(os.path.join(path, os.pardir)), "data", "lstm_model", "model_{0}.keras".format(data)))

    if(os.path.exists(os.path.join(os.path.abspath(os.path.join(path, os.pardir)), "data", "lstm_model", "model_{0}_checkpoint.keras".format(data)))):
        os.remove(os.path.join(os.path.abspath(os.path.join(path, os.pardir)), "data", "lstm_model", "model_{0}_checkpoint.keras".format(data)))
