...
RUN python3 -m pip install numpy tensorflow==2.18 keras art pandas scikit-learn matplotlib keras-tcn==3.1.2 asciichartpy==1.5.25 pmdarima==2.0.4 statsmodels==0.14.4
